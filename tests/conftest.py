...
from coffee_shop.db.utils import create_database, drop_database
from coffee_shop.services.redis.dependency import get_redis_pool
from coffee_shop.settings import settings
from coffee_shop.web.application import get_app
...
async def _engine() -> AsyncGenerator[AsyncEngine, None]:
    ...
    from coffee_shop.db.models import load_all_models
